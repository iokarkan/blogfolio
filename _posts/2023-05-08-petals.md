...
<div class="m-auto sm:p-5 rounded-full">
    <img class="m-auto rounded-lg" src="{{site.baseurl}}/assets/img/petals_logo.png">
...
<figcaption class='text-center'>
        (Table from <a href="https://arxiv.org/pdf/2209.01188.pdf">https://arxiv.org/pdf/2209.01188.pdf</a>.)
    </figcaption>
</div>
